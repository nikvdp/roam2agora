...
def make_exe(dist):
    ...
    # python_config.run_module = "roam2agora.main"
    ...
    # # didn't work: ImportError: attempted relative import with no known parent package
    # python_config.run_filename = CWD + "/src/roam2agora/main.py"
    # python_config.run_code = "from roam2agora.main import main; main()"
